...
<div class="small-container single-product">
	<div class="row">
		<div class="col-2">
			<img src="images/Agv/agv3.png" width="100%" id="product-img">

			<div class="small-img-row">
				<div class="small-img-col">
					<img src="images/Agv/agv3.png" width="100%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="images/Agv/agv1.png" width="100%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="images/Agv/agv2.png" width="100%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="images/Agv/agv4.png" width="100%" class="small-img">
				</div>
			</div>
