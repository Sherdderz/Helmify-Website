...
<div class="small-container single-product">
	<div class="row">
		<div class="col-2">
			<img src="images/bogo/glass bogo4.png" width="100%" id="product-img">

			<div class="small-img-row">
				<div class="small-img-col">
					<img src="images/bogo/glass bogo4.png" width="100%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="images/bogo/blue bogo1.png" width="100%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="images/bogo/yellow bogo3.png" width="100%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="images/bogo/silver bogo2.png" width="100%" class="small-img">
				</div>
			</div>
