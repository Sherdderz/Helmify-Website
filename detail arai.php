...
<div class="small-container single-product">
	<div class="row">
		<div class="col-2">
			<img src="images/Arai/arai1.png" width="100%" id="product-img">

			<div class="small-img-row">
				<div class="small-img-col">
					<img src="images/Arai/arai1.png" width="100%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="images/Arai/arai2.png" width="100%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="images/Arai/arai3.png" width="100%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="images/Arai/arai4.png" width="100%" class="small-img">
				</div>
			</div>

		</div>
		<div class="col-2">
			<h1>Helm Arai Fullfest</h1>
			<h4>Rp8.720.000</h4>
