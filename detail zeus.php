...
<div class="small-container single-product">
	<div class="row">
		<div class="col-2">
			<img src="images/Zeus/produk2.png" width="100%" id="product-img">

			<div class="small-img-row">
				<div class="small-img-col">
					<img src="images/Zeus/produk2.png" width="100%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="images/Zeus/zeus1.png" width="100%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="images/Zeus/zeus2.png" width="100%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="images/Zeus/zeus3.png" width="100%" class="small-img">
				</div>
			</div>

		</div>
		<div class="col-2">
			<h1>Helm Zeus Keren Banget</h1>
			<h4>Rp550.000</h4>
