...
<div class="small-container single-product">
	<div class="row">
		<div class="col-2">
			<img src="images/tdXfm/td x fm4.png" width="100%" id="product-img">

			<div class="small-img-row">
				<div class="small-img-col">
					<img src="images/tdXfm/td x fm1.png" width="100%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="images/tdXfm/td x fm2.png" width="100%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="images/tdXfm/td x fm3.png" width="100%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="images/tdXfm/td x fm4.png" width="100%" class="small-img">
				</div>
			</div>
