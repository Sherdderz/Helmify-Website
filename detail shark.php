...
<div class="small-container single-product">
	<div class="row">
		<div class="col-2">
			<img src="images/shark4.png" width="100%" id="product-img">

			<div class="small-img-row">
				<div class="small-img-col">
					<img src="images/shark/shark4.png" width="100%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="images/shark/shark1.png" width="100%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="images/shark/shark2.png" width="100%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="images/shark/shark3.png" width="100%" class="small-img">
				</div>
			</div>

		</div>
		<div class="col-2">
			<h1>Helm Shark Yang dipake Lorenzo</h1>
			<h4>Rp2.800.000</h4>
