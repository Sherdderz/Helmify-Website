...
<div class="small-container single-product">
	<div class="row">
		<div class="col-2">
			<img src="images/ink/ink2.png" width="100%" id="product-img">

			<div class="small-img-row">
				<div class="small-img-col">
					<img src="images/ink/ink2.png" width="100%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="images/ink/ink1.png" width="100%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="images/ink/ink3.png" width="100%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="images/ink/ink4.png" width="100%" class="small-img">
				</div>
			</div>

		</div>
		<div class="col-2">
			<h1>Helm INK Menarik</h1>
			<h4>Rp430.000</h4>
